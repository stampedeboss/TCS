...
TCS.Config.A2G = {
  ...
  MISSION_YEAR_FLAG = 285999, -- Flag number that holds the actual year (e.g., 1985)
  ...
  BAI = { MOVE_SPEED_KPH = 25, MIN_SPAWN_DISTANCE_NM = 5, MAX_SPAWN_DISTANCE_NM = 15 }, -- New setting for BAI
  SEAD = { MIN_SPAWN_DISTANCE_NM = 2, MAX_SPAWN_DISTANCE_NM = 6 },
  DEAD = { MIN_SPAWN_DISTANCE_NM = 2, MAX_SPAWN_DISTANCE_NM = 6 },
  STRIKE = { MIN_SPAWN_DISTANCE_NM = 0, MAX_SPAWN_DISTANCE_NM = 3 },
