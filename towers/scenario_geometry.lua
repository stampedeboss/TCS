...
function TCS.Common.Geometry.GetDirectionalPoint(anchor, minNm, maxNm, heading, arc)
    local dist = math.random(minNm or TCS.Config.Ground.Defaults.GEOMETRY_DEFAULTS.MIN_SPAWN_NM, maxNm or TCS.Config.Ground.Defaults.GEOMETRY_DEFAULTS.MAX_SPAWN_NM) * 1852
