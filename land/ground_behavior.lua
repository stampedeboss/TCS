...
TCS.Towers.Land.Behavior = {}

--- Applies tactical behavior to a spawned ground group.
function TCS.Towers.Land.Behavior.ApplyBehavior(group, behavior)
...
function TCS.Towers.Land.Behavior.GetRetreatPoint(anchor, spawnAnchor)
    local dir = anchor:HeadingTo(spawnAnchor) or 0
    return anchor:Translate(15000, dir)
end

env.info("TCS(TOWER.LAND.BEHAVIOR): ready")