...
load_tcs([[config\ground\catalog.lua]])
load_tcs([[config\ground\defaults.lua]])
load_tcs([[config\air\catalog.lua]])
load_tcs([[config\air\defaults.lua]])
load_tcs([[config\airdef\catalog.lua]])
load_tcs([[config\airdef\defaults.lua]])
...
load_tcs([[common\session_class.lua]])
load_tcs([[common\session_utils.lua]])
load_tcs([[common\session_manager.lua]])
load_tcs([[common\session_cleanup.lua]])
...
load_tcs([[towers\airdef_catalog.lua]])
load_tcs([[config\airdef\compositions_pools.lua]])
load_tcs([[config\airdef\compositions_mobile.lua]])
load_tcs([[towers\airdef_compositions.lua]])
load_tcs([[towers\airdef_inventory.lua]])
load_tcs([[towers\airdef.lua]])
load_tcs([[towers\air_catalog.lua]])
...
-- Diagnostic: Mission Year Confirmation
local mYear = TCS.Common.Config.GetMissionYear()
env.info(string.format("TCS(LOAD): Active Mission Year set to %s", (mYear > 0 and tostring(mYear) or "UNLIMITED")))
