---------------------------------------------------------------------
-- TCS AIR SETTINGS & DEFAULTS
-- Consolidated tuning parameters for Air scenarios and flight envelopes.
---------------------------------------------------------------------
env.info("TCS(AIR.SETTINGS): loading")

TCS = TCS or {}
TCS.Air = TCS.Air or {}

TCS.Air.Settings = {
    -- 1. Air Domain Defaults
    ...
    INTENT = {
        ...
        ACM       = { minNm = 5,  maxNm = 15,  arc = 180 },
        BVR       = { minNm = 30, maxNm = 50,  arc = 180 }
    },
    ...
    DEFAULT_MIN_NM = 40,
    DEFAULT_MAX_NM = 80,
    REINFORCE_THRESHOLD = 0.50, -- Standard Air reinforcement trigger
      ...
      DIFFICULTY = {
        ...
        ["RANDOM"] = {
          ...
          resolve = function(self)
            return TCS.Air.ResolveDifficulty(self.weights)
          end
        },
      }
    },
    ...
    FORMATION = { ECHELON_RIGHT_SPACING_M = 50 },
    AMBIENT = {
        DEFAULT_DENSITY = 0.5, DEFAULT_MAX_ITEMS = 50, DEFAULT_DISPERSION_NM = 1,
        COLLISION_RADIUS_M = 15, TRAFFIC_MIN = 1, TRAFFIC_MAX = 2
    },
    FLIGHT_MANAGER = {
        CAP_DETECTION_RADIUS_NM = 40, DEFAULT_ATTRITION_THRESHOLD = 0.65,
        RADAR_ACQUISITION_DELAY_SEC = 3, MONITOR_INTERVAL_SEC = 10, AWACS_UPDATE_INTERVAL_SEC = 30
    }
}

env.info("TCS(AIR.SETTINGS): ready")