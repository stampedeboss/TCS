...
TCS.Towers.Land.Compositions = {}

TCS.Towers.Land.Compositions.Blueprints = {
    ...
    -- 6. STRIKE_TARGET: Fixed facility with embedded defense
    STRIKE_TARGET = {
        baseSize = 4,
        ratios = {
            STRUCTURE = { weight = 1.0 }, -- Buildings/Depots (Main target)
            AIRDEF    = 0.5,              -- Embedded AAA/SAM point defense
            ARMOR     = 0.2               -- Static security force
        }
    },
...
env.info("TCS(TOWER.LAND.COMPOSITIONS): ready")